class Program
{
    ...
    class Round
    {
        ...
        public void SetMe(char c)
        {
            ...
            switch (c)
            {
                case 'X': Me = GetLosingHand(Opponent); break;
                case 'Y': Me = Opponent; break;
                case 'Z': Me = GetWinningHand(Opponent); break;
            }
        }

        private Hand GetLosingHand(Hand i)
        {
            switch (i)
            {
                case Hand.Rock: return Hand.Scissors;
                case Hand.Paper: return Hand.Rock;
                case Hand.Scissors: return Hand.Paper;
